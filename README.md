...
[v1.x branch](https://github.com/hokify/cordova-plugin-push/tree/v1.x).
...
[Notification vs Data Payload](https://github.com/hokify/cordova-plugin-push/blob/master/docs/PAYLOAD.md#notification-vs-data-payloads).
